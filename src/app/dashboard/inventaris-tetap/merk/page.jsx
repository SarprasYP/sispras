...
export default function BrandPage() {
  ...
  const {
    ...
    setFilterModel,
    refreshData,
  } = useDataGridServer(getPaginatedBrands);
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      setSnackbar({
        open: true,
        message: error.message || "Gagal menghapus merk.",
        severity: "error",
      });
    } finally {
      ...
      renderCell: (params) => (
        ...
        >
          <IconButton
            ...
            onClick={() =>
              router.push(
                `/dashboard/inventaris-tetap/merk/edit/${params.id}`
              )
            }
          >
            <EditIcon />
    ...
    <Stack>
      ...
      <Box display="flex" justifyContent="end">
        <Button
          ...
          color="primary"
          onClick={() =>
            router.push("/dashboard/inventaris-tetap/merk/tambah")
          }
          sx={{ mb: 2, px: 4 }}
        >
          Tambah
      ...
      <DialogConfirmation
        ...
        content="Apakah Anda yakin ingin menghapus Merk ini? Tindakan ini tidak dapat dibatalkan."
      />
      <Snackbar
        open={snackbar.open}
